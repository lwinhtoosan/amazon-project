...
cart.forEach((cartItem) => {
  ...
  deliveryOptions.forEach((deliveryOption) => {
    if (deliveryOption.id === cartItem.deliveryOptionId) {
      matchingDeliveryId = deliveryOption
    }
  })
      
  const today = dayjs();
  const deliveryDate = today.add(
    matchingDeliveryId.deliveryDays,
    'days'
    )
  ...
  cartSummaryHTML += `<div class="cart-item-container js-cart-item-container-${
                    ...
                    <div class="cart-item-details">
                        ...
                        <input class="quantity-input js-quantity-input-${matchingProduct.id} data-product-id="${
                          matchingProduct.id
                        }">
...
function handleQuantityInput(productId,container) {
const newQuantity = Number(container.querySelector(`.js-quantity-input-${productId}`).value);
